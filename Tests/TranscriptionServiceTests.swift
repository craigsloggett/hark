...
struct TranscriptionServiceTests {
    ...
    @Test func rerenderSubstitutesNamesFromOverlay() throws {
        ...
        try session.writeSpeakers(["speaker1": SpeakerIdentity(id: "v1", name: "Alice")])

        try TranscriptionService.rerenderTranscript(at: session.url)
    ...
    @Test func speakersOverlayRoundTrips() throws {
        ...
        let overlay = ["speaker1": SpeakerIdentity(id: "v1", name: "Alice")]
